...
%AP181230: IMPORTANT: Enc is randomized - and must be so: deterministic functions are inherently not secure, refer to page 72 of Katz-Lindell
...
\begin{cryptogame}
    ...
    \challenger{$k \pickUAR \{0, 1\}^\lambda$}
