...
We can observe that the image of this function is a subset of $\mathbb{Z}^{*}_{n} $.
...
Therefore, we have that the Rabin's TDP is a permutation, and that the cardinality of $ \mathbb{QR}_{n} $ is $\frac{|\mathbb{Z}^{*}_{n} |}{4}$.
