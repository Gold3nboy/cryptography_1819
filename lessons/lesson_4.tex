...
\begin{proof}
    ...
    \begin{cryptogame}{fdistin}{A distinguisher for $f$}{$f$-\textsc{dist}}
        ...
        \receive{\shortstack[l]{
            $Z \pickUAR \{X_\lambda, Y_\lambda\}$ \\
            $z \pickUAR Z$
        }}
        {$(X_\lambda, Y_\lambda, f(z))$}
        {}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            \mess{C}{$(X_\lambda, Y_\lambda, z)$}{D}
            ...
            \mess{D}{$(X_\lambda, Y_\lambda, f(z))$}{A}
            
            % Adversary distinguishes betweeen the two distributions
            \mess{A}{$Z'$}{D}

            \mess{D}{$Z'$}{C}
            \node[anchor=west] at (mess to) {\textsc{Output 1 iff} $Z' = Z$};
