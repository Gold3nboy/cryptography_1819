...
\begin{proof}
    ...
    \begin{tikzpicture}[line width=1pt,>=latex]
        \sffamily
        \node (a1) {};
        \node[below=0.5cm of a1] (a2) {};
        \node[below=0.5cm of a2] (a3) {};

        \node[below=0.5cm of a3] (a4) {};
        \node[below=0.5cm of a4] (a5) {};
        \node[below=0.5cm of a5] (a6) {};
        ...
        \node[ellipse,draw=black,minimum size=3cm,fit={(a1) (a6)}] {};
    ...
    \end{tikzpicture}\\
    %how do you split an ellipse in haf? I don't know
    \bigskip
